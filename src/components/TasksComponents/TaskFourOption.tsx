...
import TaskFourAnimated from "./TaskFourAnimated";

function TaskFourOptions() {
  ...
  return (
    <div className="flex p-4">
      {isPlaying ? (
        <TaskFourAnimated planetNames={PlanetsSelected} />
      ) : (
        <TaskFour planetNames={PlanetsSelected} />
      )}
...
export default TaskFourOptions;
